...
Demo Dataset dist： 
```bash
D:\Python Project\Deep-Traffic\pre-processing\4_Png_16_USTC\Train\Htbot
D:\Python Project\Deep-Traffic\pre-processing\4_Png_16_ISAC\Train\Zeus
D:\Python Project\Deep-Traffic\pre-processing\4_Png_16_CTU\Train\Coinminer

test demo 
first cd to improved-diffusion/scripts

then run
python image_train.py --data_dir 'D:\Python Project\Deep-Traffic\pre-processing\4_Png_16_CTU\Train\Coinminer' --epochs 2 --diffusion_steps 50 --noise_schedule cosine --lr 1e-4 --batch_size 16

```
Windows users may need to install mpi4py at first. [https://www.microsoft.com/en-us/download/details.aspx?id=57467]
...
```
MODEL_FLAGS="--image_size 16 --num_channels 128 --num_res_blocks 3"
DIFFUSION_FLAGS="--diffusion_steps 50 --noise_schedule cosine"
TRAIN_FLAGS="--lr 1e-4 --batch_size 128"
```
