...
def main():
    ...
    image_path = os.path.join(data_root, "datasets", "USTC-new-new-improved-CVAE")
    ...
    for i in range(EP):
        ...
        best_acc = 0.0
        save_path = './resnet-USTC-new-improved-DiffTPT-spite-new-' + str(i) + '.pth' # resnet-ustc-new-improved-row-
        ...
        for epoch in range(epochs):
            ...
            # optimizer = optim.Adam(params, lr=0.0001) # 0.0001
